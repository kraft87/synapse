@echo off
REM synapse-devices — approve / list / mint / revoke Synapse device credentials.
REM Claude Code puts a plugin's bin\ on PATH, so this is just `synapse-devices approve <CODE>`
...
REM Requires a FULL-TRUST device token — the shared enrollment token is refused by design.
setlocal
