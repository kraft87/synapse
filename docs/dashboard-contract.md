...
`/dash/api/behavior/*`, `/dash/api/dream/report`.
...
`/dash/api/metrics/{recall,ingestion,corpus}` shipped in phase 4;
`/dash/api/graph/{entities,neighborhood}` shipped in phase 6 — see above.)
